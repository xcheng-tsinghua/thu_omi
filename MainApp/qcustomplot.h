...
/*********************** How to use QCustomPlot *************************************
**	Summarized by Jacky, L., ZENG @ 2013-01-23									   **
**	step1. Create a widget, customPlot, of QCustomPlot class.					   **
**	step2. Create a graph by calling customPlot->AddGraph(). 					   **
**	step3. Define the look of a graph of customPlot by accessing each graph		   ** 
**			with customPlot->graph(i), e.g. assign data, customPlot->setData(x, y).**
**	step4. redraw the plot by calling customPlot->replot().					       **
**	step5. show the widget by calling customPlot->show().    					   **
************************************************************************************/

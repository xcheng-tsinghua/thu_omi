...
*/
{
	...
	double zd = instance.nodeptr[i].z - instance.nodeptr[j].z;
    double r  = sqrt(xd*xd + yd*yd + zd*zd) + 0.5;
...
*/
{
    ...
    double yd = instance.nodeptr[i].y - instance.nodeptr[j].y;
	double zd = instance.nodeptr[i].z - instance.nodeptr[j].z;
    double r  = sqrt(xd*xd + yd*yd +zd*zd);
...
*/
{
    ...
    double yd = instance.nodeptr[i].y - instance.nodeptr[j].y;
	double zd = instance.nodeptr[i].z - instance.nodeptr[j].z;
    double rij = sqrt ((xd * xd + yd * yd +zd*zd) / 10.0);

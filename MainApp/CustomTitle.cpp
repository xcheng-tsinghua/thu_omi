...
void CustomTitle::initControl()
{
    ...
    m_pButtonMin->setToolTip(QString::fromLocal8Bit("最小化"));
    m_pButtonRestore->setToolTip(QString::fromLocal8Bit("还原"));
    m_pButtonMax->setToolTip(QString::fromLocal8Bit("最大化"));
    m_pButtonClose->setToolTip(QString::fromLocal8Bit("关闭"));
